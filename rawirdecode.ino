...
void setup(void) {
  ...
  Serial.println(F("* '7' for Daikin THC codes"));
  ...
  if (modelChoice == 1) {
    ...
    MARK_THRESHOLD_BIT_HEADER    = 2500;
    SPACE_THRESHOLD_ZERO_ONE     = 600;
    SPACE_THRESHOLD_ONE_HEADER   = 1500;
    SPACE_THRESHOLD_HEADER_PAUSE = 25500;
  }
}
...
#endif
#if defined(DAIKINTHC)
  knownProtocol = decodeDaikinTHC(bytes, byteCount);
#endif
#if defined(CARRIER)
